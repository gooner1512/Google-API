...
spreadsheet_id = '1F3sEwY3qFIhDghxoscwVQ0Q1xdQPP65sy6kifCh6oDs'
mySpreadsheets = service.spreadsheets().get(spreadsheetId=spreadsheet_id).execute()

worksheetname_list = ['LuongBanChiTiet']

db = Database()
query="""
EXEC USP_KIDS_BaoCaoSanLuongBanTheoNgay_ChiTiet_Cach2 '20230211','20230211'
"""
